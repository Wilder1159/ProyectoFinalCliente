...
public class JMain extends javax.swing.JFrame {
    ...
    private void btnConActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConActionPerformed
        // por si viste un tutoria como pasar el boton de continuar al otro frame // se llamaa como conectarlo
        //obtenemos los datos de txt como enseño el profe en clase
        String nombre = txtNombre.getText();
        Double saldoInicial = Double.parseDouble(txtSaldo.getText()); // se recuerda usar parse para datos tipo entero en txt de tipo String
        
        //se pide al controlador que crea al cliente con el metodo construido
        controller.crearCliente(nombre, saldoInicial);
        ...
        this, 
                ...
                + "\nSaldo Incial: S/ " + cliente.getSaldoFinal() + "\n"
                + "Saldo Actual: S/ " + cliente.getSaldoFinal()
        );
